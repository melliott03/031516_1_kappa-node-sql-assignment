...
if(process.env.DATABASE_URL != undefined) {
    ...
    connectionString = 'postgres://localhost:5432/newdatabaseijustcreated';
}
...
app.delete('/people', function(req, res) {
    ...
    pg.connect(connectionString, function(err, client, done) {
        client.query("DELETE FROM people WHERE id=$1 RETURNING id, name, address, city, state, zip_code;",
            [id],
            function (err, result) {
                done();
